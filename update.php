...
<!-- contents -->
  ...
  <section id = "section1">
		<div class="title">Update Features Marutisuzuki </div>
		<h2>to delete any information or row <a href="delete.php">here</a></h2>
		
		<form action="insert_update.php" class="form_design" method="post">
			Model: <input type="text" name="mod"> <br/>
			Engine: <input type="text" name="eng"> <br/>
			Transmission: <input type="text" name="tra"> <br/>
			Milage: <input type="text" name="mil"> <br/>
			Max Power: <input type="text" name="map"> <br/>
			Fuel: <input type="text" name="fue"> <br/>
			Color: <input type="text" name="clo"> <br/>
			Availability: <input type="text" name="ava"> <br/>
...
<section id = "section1">
		<div class="title">Update Features Hyundai </div>
		<h2>to delete any information or row <a href="deletehyundai.php">here</a></h2>

		<form action="update2.php" class="form_design" method="post">
			Model: <input type="text" name="mod"> <br/>
			Engine: <input type="text" name="eng"> <br/>
			Transmission: <input type="text" name="tra"> <br/>
			Milage: <input type="text" name="mil"> <br/>
